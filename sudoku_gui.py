...
class SudokuGUI:
    def __init__(self, root: tk.Tk):
        ...
        self.container_frame = tk.Frame(self.root, bg='#FFFFFF')
        self.container_frame.config(padx=10, pady=10, bg='#FFFFFF')
        self.container_frame.pack(fill=tk.BOTH, expand=True)
        
        # self.container_frame.grid_rowconfigure(0, weight=2)
        # self.container_frame.grid_columnconfigure(0, weight=2)
